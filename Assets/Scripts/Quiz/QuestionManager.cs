...
public class QuestionManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        {
            questions.Add(new Question("สารเสพติดประเภทกดประสาทได้แก่อะไรบ้าง?", "ยาบ้า กาว", "เห็ดขี้ควาย แอลเอสดี", "กาว ฝิ่น", "ช่อดอกกัญชา กาว", 3, scoreToAdd));
            questions.Add(new Question("อาการของคนเสพสารเสพติดประเภทกดประสาทมีอาการอย่างไร?", "ร่าเริง ช่างพูด", "อ่อนเพลีย ฟุ้งซ่าน", "หงุดหงิด คลุ้มคลั่ง", "ถูกทุกข้อ", 2, scoreToAdd));
            questions.Add(new Question("กาว และเหล้าเป็นสารเสพติดออกฤทธิ์อย่างไร?", "กดประสาท", "กระตุ้นประสาท", "ผสมผสาน", "หลอนประสาท", 1, scoreToAdd));
            questions.Add(new Question("กาว ฝิ่น ยาบ้า อะไรไม่ใช่สารเสพติดประเภทกดประสาท?", "กาว", "ฝิ่น", "ยาบ้า", "ไม่มีข้อถูก", 3, scoreToAdd));
            questions.Add(new Question("เฮโรอีน จัดเป็นสารเสพติดที่สอดคล้องกับข้อใด?", "เป็นสารเสพติดประเภทที่ 1", "เป็นสารเสพติดประเภทที่ 2", "เป็นสารเสพติดประเภทที่ 3", "เป็นสารเสพติดประเภทที่ 4", 1, scoreToAdd));
            questions.Add(new Question("ฝิ่นออกฤทธิ์ต่อร่างกายอย่างไร?", "กดประสาท", "กระตุ้นประสาท", "ผสมผสาน", "หลอนประสาท", 1, scoreToAdd));
        }else if(questionLevel == 2)
        {
            questions.Add(new Question("สารเสพติดประเภทกระตุ้นประสาทได้แก่อะไรบ้าง?", "ยาบ้า กาว", "กาว ฝิ่น", "ยาบ้า ยาอี", "ช่อดอกกัญชา กาว",3,scoreToAdd));
            questions.Add(new Question("อาการของคนเสพสารเสพติดประเภทกระตุ้นประสาทมีอาการอย่างไร?", "ร่าเริง ช่างพูด", "อ่อนเพลีย ฟุ้งซ่าน", "หงุดหงิด กระวนกระวาย", "ถูกทุกข้อ",3,scoreToAdd));
            questions.Add(new Question("ใบกระท่อม ยาบ้าและยาอีเป็นสารเสพติดออกฤทธิ์อย่างไร?", "กดประสาท", "กระตุ้นประสาท", "ผสมผสาน", "หลอนประสาท",2,scoreToAdd));
            questions.Add(new Question("โคเคน ฝิ่น ยาบ้า อะไรไม่ใช่สารเสพติดประเภทกระตุ้นประสาท?", "โคเคน", "ฝิ่น", "ไม่ใช่ทั้ง โคเคน และ ฝิ่น", "ไม่มีข้อถูก",2,scoreToAdd));
            questions.Add(new Question("โคเคนออกฤทธิ์ต่อร่างกายอย่างไร?", "กระตุ้นประสาท", "กดประสาท", "ผสมผสาน", "หลอนประสาท",1,scoreToAdd));
            questions.Add(new Question("ยาบ้า ยาอีจัดเป็นสารเสพติดที่สอดคล้องกับข้อใด?", "เป็นสารเสพติดประเภทที่ 1", "เป็นสารเสพติดประเภทที่ 2", "เป็นสารเสพติดประเภทที3", "เป็นสารเสพติดประเภทที่ 4",2,scoreToAdd));
        } 
        else if(questionLevel == 3)
        {
            questions.Add(new Question("เห็ดขี้ควายเป็นสารเสพติดที่ให้โทษอย่างไร?", "กดประสาท", "กระตุ้นประสาท", "ผสมผสาน", "หลอนประสาท",4,scoreToAdd));
            questions.Add(new Question("อาการของคนเสพสารเสพติดประเภทหลอนประสาท มีอาการอย่างไร?", "อารมณ์ดี ยิ้มแย่มสดใส", "หูแว่ว เห็นภาพหลอน", "ร่าเริง ช่างพูด", "ถูกทุกข้อ",2,scoreToAdd));
            questions.Add(new Question("อาการของคนเสพสารเสพติดประเภทออกฤทธิ์ผสมผสาน มีอาการอย่างไร?", "ร่าเริง ช่างพูด", "หัวเราะตลอดเวลา", "ง่วงนอน เซื่องซึม", "ถูกทุกข้อ",4,scoreToAdd));
            questions.Add(new Question("ในเกมกระสุนประเภทออกฤทธิ์ผสมผสานใช้จัดการกับศัตรูอะไร?", "ช่อดอกกัญชา", "เหล้า", "ฝิ่น", "กาว",1,scoreToAdd));
            questions.Add(new Question("สารเสพติดประเภทหลอนประสาทได้แก่อะไรบ้าง?", "เห็ดขี้ควาย กาว", "เห็ดขี้ควาย แอลเอสดี", "กาว ฝิ่น", "ช่อดอกกัญชา เห็ดขี้ควาย",2,scoreToAdd));
            questions.Add(new Question("วิธีที่ดีที่สุดที่จะไม่ตกเป็นทาสยาเสพติดคือข้อใด?", "การป้องกันชุมชน,การป้องกันสังคม", "การป้องกันสังคม,การป้องกันตัวเอง", "การป้องกันชุมชน,การป้องกันสังคม,การป้องกันตนเอง", "การป้องกันชุมชน,การป้องกันตนเอง,การป้องกันครอบครัว",4,scoreToAdd));
            questions.Add(new Question("เห็ดขี้ควายจัดเป็นสารเสพติดที่สอดคล้องกับข้อใด?", "เป็นสารเสพติดประเภทที่ 1", "เป็นสารเสพติดประเภทที่ 2", "เป็นสารเสพติดประเภทที่ 3", "เป็นสารเสพติดประเภทที่ 4",3,scoreToAdd));
            questions.Add(new Question("ช่อดอกกัญชากับเห็ดขี้ควายเป็นสารเสพติดออกฤทธิ์ ประเภทเดียวกันหรือไม่?", "เป็นสารเสพติดประเภทเดียวกัน", "เป็นสารเสพติดคนละประเภท", "เห็ดขี้ควายไม่ใช่สารเสพติด", "ไม่มีข้อถูก",2,scoreToAdd));
        }
