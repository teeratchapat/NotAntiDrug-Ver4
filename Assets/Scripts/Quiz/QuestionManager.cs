...
public class QuestionManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        {
            questions.Add(new Question("เห็ดขี้ควายเป็นสารเสพติดที่ให้โทษอย่างไร?", "กดประสาท", "กระตุ้นประสาท", "ผสมผสาน", "หลอนประสาท",4,100));
            questions.Add(new Question("อาการของคนเสพสารเสพติดประเภทหลอนประสาท มีอาการอย่างไร?", "อารมณ์ดี ยิ้มแย่มสดใส", "หูแว่ว เห็นภาพหลอน", "ร่าเริง ช่างพูด", "ถูกทุกข้อ",2,100));
            questions.Add(new Question("อาการของคนเสพสารเสพติดประเภทออกฤทธิ์ผสมผสาน มีอาการอย่างไร?", "ร่าเริง ช่างพูด", "หัวเราะตลอดเวลา", "ง่วงนอน เซื่องซึม", "ถูกทุกข้อ",4,100));
            ...
            questions.Add(new Question("เห็ดขี้ควายจัดเป็นสารเสพติดที่สอดคล้องกับข้อใด?", "เป็นสารเสพติดประเภทที่ 1", "เป็นสารเสพติดประเภทที่ 2", "เป็นสารเสพติดประเภทที่ 3", "เป็นสารเสพติดประเภทที่ 4",3,100));
            questions.Add(new Question("ช่อดอกกัญชากับเห็ดขี้ควายเป็นสารเสพติดออกฤทธิ์ ประเภทเดียวกันหรือไม่?", "เป็นสารเสพติดประเภทเดียวกัน", "เป็นสารเสพติดคนละประเภท", "เห็ดขี้ควายไม่ใช่สารเสพติด", "ไม่มีข้อถูก",2,100));
        }
